...
import (
	...
	"github.com/pablogore/atomwright/v2/internal/agents/capabilitymanifest"
...
const reviewerInspectionCommandPrefix = `atomwright review inspect-candidate --repository-context <repository_context> --expected-revision <revision> --lineage <lineage> --target <target> --lens <lens> --order <order> --operation `
