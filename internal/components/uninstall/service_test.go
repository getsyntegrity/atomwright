...
import (
	...
	"github.com/pablogore/atomwright/v2/internal/agents/pi"
...
func TestCompleteUninstallKeepsExecutableRemovalAction(t *testing.T) {
	...
	want := "To completely remove atomwright from your system, delete the executable (e.g., rm -f $(which atomwright))"
...
func TestComponentOperationsSDD_OpenCodeRemovesManagedPluginSourcesAndModelVariantsCache(t *testing.T) {
	...
	cacheDir := filepath.Join(homeDir, ".atomwright", "cache")
