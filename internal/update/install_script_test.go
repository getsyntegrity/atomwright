...
`)
	...
	want := strings.Join([]string{
		"github.com/pablogore/atomwright/v2,example.com/private",
		"github.com/pablogore/atomwright/v2,github.com/acme/*",
...
func TestWindowsInstallScriptBetaGoInstallPreservesGoProxyBypassEnv(t *testing.T) {
	...
	for _, clobber := range []string{
		"$env:GONOSUMDB = \"github.com/pablogore/atomwright/v2\"",
		"$env:GOPRIVATE = \"github.com/pablogore/atomwright/v2\"",
		"$env:GONOPROXY = \"github.com/pablogore/atomwright/v2\"",
	} {
		if strings.Contains(script, clobber) {
